...
const PRICING_DATA = {
  ...
  reception: [
    ...
    { id: 3, name: 'Long reception dress with normal beaded lace', price: 'GHS 9,000 - GHS 12,000', popular: false,
      desc: 'Statement shower look with feathers, pearls, or custom embroidery. 3 fittings included.',  
    },
    { id: 4, name: 'Short Reception dress with luxury lace', price: 'GHS 9,000 - GHS 15,000', popular: false,
      desc: 'Statement shower look with feathers, pearls, or custom embroidery. 3 fittings included.',  
    },
    { id: 6, name: 'Luxe reception dress', price: 'GHS 13,000 - GHS 17,000', popular: false,
      desc: 'Statement shower look with feathers, pearls, or custom embroidery. 3 fittings included.',  
    },
    { id: 7, name: 'Deluxe reception dress', price: 'GHS 17,000 GHS 25,000', popular: false,
      desc: 'Statement shower look with feathers, pearls, or custom embroidery. 3 fittings included.',  
    },
